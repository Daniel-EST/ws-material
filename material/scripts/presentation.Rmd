...
slides > slide:not(.nobackground):before {
  ...
  bottom: 20px;
  left: 60px;
  background: url('../../src/img/logo.png') no-repeat 0 50%;
...
web scraping é uma técnica de coleta online que por meio de processos automatizados realiza uma _raspagem_ (scraping) de uma página da web, estruturando informações contidas no site.

<div class="columns-2" class="centered">
```{r echo=FALSE, out.height='200px', out.width='375px', fig.cap = 'Dados estruturados'}
...
```{r echo=FALSE, out.height = '280px', out.width = '250px', fig.align = 'center'}
...
```{r echo=FALSE, out.height = '280px', out.width='700px', fig.align = 'center'}
...
```{r echo=FALSE, out.height = '255px', out.width = '300px', fig.align = 'center', fig.cap = 'Copiando o xpath de um node'}
...
knitr::include_graphics("../../src/img/rvest.jpg")
```
</div>
...
```{r echo=FALSE, out.height = '155px', out.width='500px', fig.align = 'center', fig.cap = 'O seguinte objeto foi criado'}
...
```{r echo=FALSE, out.height = '250px', out.width = '235px', fig.align = 'center'}
...
## Exercício (RSelenium)
Com o que vimos até agora faça uma coleta simples no site da [Subamarino](https://www.submarino.com.br/) de algum produto que queira e colete as seguintes informações:  
...
- Não ultrapassar o limite de informções coletadas por dia, se houver. Entretanto, sempre manter o bom senso.

Essas boas práticas evitam o sobrecarregamento dos servidores e cause prejuízo a essas empresas.

## Captcha

```{r echo=FALSE, out.height = '600px', out.width = '700px', fig.align = 'center'}
